...
outputTest = do
    ...
    putStrLn "The result of getCateStartPos ((0,0),[(np, \"Desig\", \"Frank\",\"DE\",True)],0) [[((0,0),[(np, \"Desig\", \"Frank'\",\"DE\",True)],0),((1,0),[((s\\.np)/.np, \"Desig\", \"loves'\",\"DE\",True)],1), ((2,0),[(np, \"Desig\", \"Mary'\",\"DE\",True)],2)],[((0,1),[(s/.np, \">T->B\", \"Frank' loves'\",\"OE\",True)],1)],[((0,2),[(s, \">\", \"(Frank' loves') Mary'\",\"NR\",True)],2)]] is"
    let c11 = getCateFromString "np"
    let c12 = getCateFromString "(s\\.np)/.np"
    let c13 = getCateFromString "np"
    let c21 = getCateFromString "s/.np"
    ...
    putStrLn "The result of getCateStartPos ((1,0),[((s\\.np)/.np, \"Desig\", \"loves'\",\"DE\",True)],1) [[((0,0),[(np, \"Desig\", \"Frank'\",\"DE\",True)],0),((1,0),[((s\\.np)/.np, \"Desig\", \"loves'\",\"DE\",True)],1), ((2,0),[(np, \"Desig\", \"Mary'\",\"DE\",True)],2)],[((0,1),[(s/.np, \">T->B\", \"Frank' loves'\",\"OE\",True)],1)],[((0,2),[(s, \">\", \"(Frank' loves') Mary'\",\"NR\",True)],2)]] is"
    let c11 = getCateFromString "np"
    let c12 = getCateFromString "(s\\.np)/.np"
    let c13 = getCateFromString "np"
    let c21 = getCateFromString "s/.np"
    ...
    putStrLn "The result of getCateStartPos ((1,1),[(s\\.np, \">\", \"loves' Mary'\",\"VO\",True)],2) [[((0,0),[(np, \"Desig\", \"Frank'\",\"DE\",True)],0),((1,0),[((s\\.np)/.np, \"Desig\", \"loves'\",\"DE\",True)],1), ((2,0),[(np, \"Desig\", \"Mary'\",\"DE\",True)],2)],[((0,1),[(s/.np, \">T->B\", \"Frank' loves'\",\"OE\",True)],1)],[((0,2),[(s, \">\", \"(Frank' loves') Mary'\",\"NR\",True)],2)]] is"
    let c11 = getCateFromString "np"
    let c12 = getCateFromString "(s\\.np)/.np"
    let c13 = getCateFromString "np"
    let c21 = getCateFromString "s\\.np"
